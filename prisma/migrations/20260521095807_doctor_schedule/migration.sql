...
-- AddForeignKey
ALTER TABLE "doctor_specialites" ADD CONSTRAINT "doctor_specialites_specialitiesId_fkey" FOREIGN KEY ("specialitiesId") REFERENCES "specialities"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
